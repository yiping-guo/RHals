...
#'
#' This function loads the Mx_1x1_US data from the package, subsets it based on age and year range, and selects the specified series (Female, Male, Total).
#'
#' @param ages A vector specifying the age range to subset. Allowed range is 0 to 110.
#' @param years A vector specifying the year range to subset. Allowed range is 1933 to 2021.
...
#' 
#' @examples
#' # Load US male mortality data with ages between 60 and 89, and years between 1960 and 2009.
#' Data <- load_USData(ages = 60:89, years = 1960:2009, series = "Male")
#' @export
load_USData <- function(ages, years, series = c("Male", "Female", "Total")) {
  # Check ages
  ...
  # Load the data file
  data_file <- system.file("data", "Mx_1x1_US.txt", package = "RHals")
